...
var mines = region.select(['system:index', 'id', 'iso3', 'country', 'area'],['gid', 'mine_id', 'isoa3', 'name', 'mine_area'])
...
function export_table (table, description) { 
  Export.table.toDrive({
    ...
    folder: 'GEE',
    fileFormat: 'CSV',
    selectors: ['gid', 'mine_id', 'isoa3', 'country', 'ecoregion_id', 'ecoregion', 'biome_id', 'biome', 'mine_area', 'groups']
  });
}
